    ...
    <div class="container flex flex-wrap justify-between items-center mx-auto">
      ...
      <div class="flex items-center md:order-2 p-2">
        ...
        <button type="button" style="margin: auto" @click="Dop == true ? (Dop = false) : (Dop = true)"
          ...
          <nuxt-img  format="webp" provider="imgix" class="w-10 h-10 rounded-full m-auto dark:bg-white" src="/Intarat.png"
            alt=" Intarat" />
        </button>
        <div :class="Dop == true ? 'Block' : 'hidden'"
          ...
          id="dropdown">
          <div class="py-3 px-4 ">
            <nuxt-img  format="webp" provider="imgix" class="w-14 h-14 rounded-full m-auto" src="/Intarat.png" alt="Intarat" />
